...
templates['class_student_homework'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr>\n            <td>"
    ...
    + "</td>\n            <td>"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.submiited : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
    + "</td>\n        </tr>\n";
